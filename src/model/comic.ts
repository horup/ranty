...
export class Comic
{
    ...
    static Default():Comic
    {
        ...
        action1.actors[0] = new Actor(actors.test.happy);
        action1.actors[1] = new Actor(actors.test.happy);
        let action3 = new Action();
        action3.caption = "End of action!";
        action2.actors[0] = new Actor(actors.test.talking);
        action2.actors[1] = new Actor(actors.test.talking);
       
       
        action3.actors[0] = new Actor(actors.test.happy);
        action3.actors[1] = new Actor(actors.test.talking);
